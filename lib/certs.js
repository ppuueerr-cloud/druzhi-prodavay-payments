// Сертификаты Минцифры (Russian Trusted CA), нужные для того, чтобы
// наш сервер доверял TLS-сертификату securepay.tinkoff.ru после того,
// как банк перешёл на российские сертификаты.
// Три сертификата: корневой (Root CA) и два подчинённых (Sub CA 2022 и 2024) —
// чтобы точно совпасть с тем, что реально присылает сервер Т-Кассы.
...
const SUB_CA_2022 = `-----BEGIN CERTIFICATE-----
...
const SUB_CA_2024 = `-----BEGIN CERTIFICATE-----
...
module.exports.RUSSIAN_TRUSTED_CERTS = [ROOT_CA, SUB_CA_2022, SUB_CA_2024];
